...
func (decimalInstance *DecimalClass) EndForInt64() int64 {
...
func (decimalInstance *DecimalClass) EndForFloat64() float64 {
	return go_reflect.Reflect.MustToFloat64(decimalInstance.result.String())
}
